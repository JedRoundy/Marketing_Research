...
conjoint_prompt <- function(prompt_num, brand_1, type_1, fat_1, package_1, price_1, brand_2, type_2, fat_2, package_2, price_2){
  ...
  if(prompt_num == 3) {
    ...
    role <- 'You are taking a consumer survey on yogurt, and you are presented with three choices. Two choices will be to purchase an item with given attributes, and a third option to not purchase anything. Please respond with ONLY the option letter, i.e. A, B, C. Do NOT include any other information.'
    ...
    role <- 'You are taking a consumer survey on yogurt, and you are presented with three choices. Two choices will be to purchase an item with given attributes, and a third option to not purchase anything. Please respond with ONLY the option letter, i.e. Q, G, P. Do NOT include any other information.'
...
for (i in seq(1, k*2, by = 2)){
    ...
    response <- get_response(n = n, chat = TRUE, prompt = prompt, role = role, keywords = c('A3', 'B2','C1'))
...
assign(paste('d_', prompt_num), cbind(d[1:n,], choice_v, text_v))
