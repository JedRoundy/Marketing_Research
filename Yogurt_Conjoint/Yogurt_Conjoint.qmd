...
for (task in seq(1, k*2, by = 2)){
    ...
    for(i in seq(1, n)){
        ...
        args <- list(role_num, task_data[1,'brand_name'], task_data[1, 'type_name'], task_data[1, 'fat_name'], task_data[1, 'package_name'], task_data[1, 'price_name'], task_data[2,'brand_name'], task_data[2, 'type_name'], task_data[2, 'fat_name'], task_data[2, 'package_name'], task_data[2, 'price_name'])
...
data_r_1$prompt <- as.integer(data_r_1$prompt)
